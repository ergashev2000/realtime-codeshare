...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full h-screen flex justify-center items-center text-gray-100 max-xl:hidden">
      ...
      <div className="xl:hidden">
        <h4 className="text-center text-white flex h-screen justify-center items-center px-2">Afsuski telefondan dasturga kira olmaysiz {"("}:</h4>
      </div>
    </>
  );
}
